        ...
        <div className=" py-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 container mx-auto px-4">
                ...
                <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:scale-105 transition duration-300">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Easy Booking</h2>
                ...
                <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:scale-105 transition duration-300">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Affordable Rates</h2>
                    <p className="text-gray-600 font-medium">
                ...
                <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:scale-105 transition duration-300">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Trusted Providers</h2>
                    <p className="text-gray-600 font-medium">
                ...
                <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:scale-105 transition duration-300">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">24/7 Support</h2>
                    <p className="text-gray-600 font-medium">
