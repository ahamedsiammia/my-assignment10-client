...
const Regester = () => {
  ...
  const hendleRegester = (event) => {
    ...
    creatUser(email, password)
      .then((result) => {
        toast.success("Your Regester successfully");
        navigate("/");
  ...
  const hendleGoogleLogin = () => {
    googleLogin()
      .then((result) => {
        toast.success("Your Regester successfull");
        // navigate("/")
        setTimeout(() => {
          navigate("/");
        }, 1000);
  ...
  return (
    <div className="flex justify-center min-h-screen items-center text-black bg-[url('https://i.pinimg.com/736x/4d/88/2b/4d882bf1dd703c937cf59591e927ba22.jpg')] bg-cover bg-center">
      <div className="card bg-base-100 w-11/12 max-w-sm shrink-0 shadow-2xl ">
        <form
          onSubmit={hendleRegester}
          className="card-body bg-[url('https://i.pinimg.com/736x/28/4f/a6/284fa6e723bcd3634f0d54e354427b8e.jpg')] bg-cover bg-center rounded-xl"
        >
